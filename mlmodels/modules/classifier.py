...
class Classifier(nn.Module):
    def __init__(self, nlemb_HPs, enc_HPs, drop_rate=0.5, num_labels=None):
        super(Classifier, self).__init__()
        print("- Use the {} model".format(enc_HPs[0]))
        self.model_type = enc_HPs[0]
...
if __name__ == '__main__':
    ...
    predict_words = Tokenizer.decode_batch(label_pred.squeeze(-1).tolist(), id2lb_dict, 1)
