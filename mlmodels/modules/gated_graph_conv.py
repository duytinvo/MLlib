...
if __name__ == '__main__':
    """
    MACOSX_DEPLOYMENT_TARGET=10.9 CC=clang CXX=clang++ pip install torch_cluster torch-scatter torch-sparse torch-spline-conv
    """
    gcn = GatedGraphConv(input_dim=10, num_timesteps=3, num_edge_types=3)
    data = Data(torch.zeros((5, 10)), edge_index=[torch.tensor([[1, 2], [2, 3]]),
