...
"""
import sys
import mlmodels.demo.trans_classifier_settings as settings
from mlmodels.training.trans_classifier_model import main
...
if __name__ == '__main__':
    ...
    if '--labelfirst' not in sys.argv:
        if settings.labelfirst:
            sys.argv.append('--labelfirst')
