...
class TransLanguageModel(object):
    def __init__(self, args):
        self.args = args
        self.task = 1 if self.args.task == "sentiment" else 2
...
def main(argv):
    ...
    parser.add_argument("--task", default="response", type=str, choices=["response", "sentiment"],
    ...
    parser.add_argument("--model_name_or_path", default="distilgpt2", type=str,
